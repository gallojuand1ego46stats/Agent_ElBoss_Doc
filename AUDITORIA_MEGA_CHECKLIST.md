...
| 3.6 | Reproducibilidad (ejecutable en otra máquina) | 🟢 | Pipeline publicado como repositorio público: `https://github.com/gallojuand1ego46stats/reportes-estadisticos` con README, requirements.txt, .gitignore, datasets, código completo. Un profesor que clone puede ejecutar `pip install -r requirements.txt` y `python scripts/main.py`. | — | Ninguna |
